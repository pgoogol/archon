package com.pgoogol.finance.common.ratelimit;
...
/**
 * Wspólna ochrona wywołań zewnętrznych API: rate limiter + retry z wykładniczym
 * backoffem (Resilience4j). Ponawiane są wyłącznie {@link ExternalServiceException}
 * (5xx/timeout/429); 4xx nie są ponawiane, bo powtórzenie tego samego błędnego
 * żądania da ten sam błąd. Przy 429 z nagłówkiem Retry-After odczekiwany jest
 * wskazany czas. Limiter działa wewnątrz retry — każda ponowiona próba też
 * podlega limitowi.
 */
