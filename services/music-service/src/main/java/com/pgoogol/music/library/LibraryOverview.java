 ...
 * ekran ma pięć stref czytania, a konstruktor z dwudziestoma
 ...
 * estymacie LLM — czyli podaje na bieżąco wskaźnik będący
...
public record LibraryOverview(
     ...
     * ekran: przegląd odpowiada na „co mam w bibliotece", a nie „co z tego
    ...
    public record Sound(
        ...
        /** Metrum z metryk ręcznych — obejmuje tylko utwory z pliku. */
