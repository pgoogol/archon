...
import SetsRoute from './SetsRoute'
import { aPlaylist, aPlaylistSummary, aPlaylistTrack, aTrack } from '@/features/music/test/fixtures'
...
describe('SetsRoute — układanie i domykanie setu', () => {

  it('tryb układania decyduje o kolejności wysłanej do API (M4.5)', async () => {

    renderRoute(<SetsRoute />, { selectedIds: new Set(), clearSelection: vi.fn() })
