...
import { api, type PlaylistResponse, type PlaylistSummaryResponse, type PlaylistTrackResponse } from '@/features/music/api'
import BpmCurve from '@/features/music/components/BpmCurve'
import Collapsible from '@/shared/ui/Collapsible'
import { useToast } from '@/shared/ui/Toasts'
import { useHashRoute } from '@/shared/hooks/useHashRoute'
import { refreshLabel, usePlaylistRefresh } from '@/features/music/hooks/usePlaylistRefresh'
import { DASH, formatDateTime, formatDuration, formatTotalDuration } from '@/shared/format'
import { SLOT_LABELS, SLOT_ORDER, spotifyTrackUrl, type SlotKey } from '@/features/music/format'
import { computeSetStats } from '@/features/music/setPlanner'
  ...
  if (openId !== null) {
    return (
      <PlaylistDetails
        ...
        onPlan={(id) => navigate('music', 'sets', new URLSearchParams({ set: String(id) }))}
      />
    )
  }
