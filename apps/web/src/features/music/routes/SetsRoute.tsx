...
import SetFillPanel from '@/features/music/components/SetFillPanel'
import SetGeneratorPanel from '@/features/music/components/SetGeneratorPanel'
import SetStats from '@/features/music/components/SetStats'
import SetSuggestionList from '@/features/music/components/SetSuggestionList'
import { useToast } from '@/shared/ui/Toasts'
import { useHashRoute } from '@/shared/hooks/useHashRoute'
import { DASH, formatDuration } from '@/shared/format'
import { slotLabel } from '@/features/music/format'
import {
  ARRANGE_LABELS,
  ARRANGE_MODES,
  arrangeBy,
  insertLastAt,
  type ArrangeMode,
} from '@/features/music/setPlanner'
...
export default function SetsRoute() {
  ...
  const { selectedIds, clearSelection: onSelectionUsed } = useMusicWorkspace()
