...
import ColumnChart from '@/features/music/viz/ColumnChart'
import { useToast } from '@/shared/ui/Toasts'
import AreaChart from '@/features/music/viz/AreaChart'
import CamelotWheel from '@/features/music/viz/CamelotWheel'
import CoverStrip from '@/features/music/viz/CoverStrip'
import Gauge from '@/shared/viz/Gauge'
import HeatMatrix from '@/features/music/viz/HeatMatrix'
import RadarChart from '@/features/music/viz/RadarChart'
import RankedBars from '@/features/music/viz/RankedBars'
import StackedBar from '@/features/music/viz/StackedBar'
import StatTile from '@/shared/viz/StatTile'
import TagCloud from '@/features/music/viz/TagCloud'
import {
  coverageParts,
  cumulativeGrowth,
  formatMinutes,
  ...
  readinessScore,
  sumBuckets,
} from '@/features/music/overviewInsights'
...
export default function OverviewRoute() {
  ...
  const { refreshKey } = useMusicWorkspace()
