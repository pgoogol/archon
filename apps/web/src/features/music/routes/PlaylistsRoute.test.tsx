...
import type { PlaylistRefreshStatusResponse } from '@/features/music/api'
import { aPlaylist, aPlaylistSummary, aPlaylistTrack } from '@/features/music/test/fixtures'
...
describe('PlaylistsRoute', () => {

  it('wypisuje playlisty jako kafle i szuka po nazwie', async () => {

    const user = userEvent.setup()
    renderRoute(<PlaylistsRoute />, { refreshKey: 0 })
...
describe('PlaylistsRoute — odświeżanie w tle (M4.7)', () => {
