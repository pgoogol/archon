...
import { aPage, aRow } from '@/features/music/test/fixtures'
import { jsonResponse } from '@/shared/test/renderWithToasts'
import type { MusicWorkspace } from '@/features/music/state/MusicWorkspace'
import { renderRoute } from '@/features/music/test/renderRoute'
...
function renderLibrary(overrides: Partial<MusicWorkspace> = {}) {
  ...
  renderRoute(<LibraryRoute />, props)
  return props
}
...
describe('LibraryRoute', () => {
  ...
  it('zaznaczenie wiersza zgłasza nowy zbiór identyfikatorów', async () => {
    ...
    expect(props.setSelectedIds).toHaveBeenCalledWith(new Set(['sp-vivir']))
  })
